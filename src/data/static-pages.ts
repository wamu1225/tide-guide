...
export const ABOUT_CONTENT = `本サイト「${SITE_NAME}」は、潮の満ち引き（潮汐）のしくみを、今日の潮回りとあわせて一目で確かめられるようにまとめたものです。トップでは今日の潮回りの目安を示し、各ページで起潮力と潮汐バルジ、大潮と小潮、地域で違う干満差、潮汐表と基準面、高潮や津波との違い、暮らしとの関わりまでを扱います。
...
潮汐の周期や干満差、潮回りの日数は、いずれも目安です。トップに表示する今日の潮回りも、月の満ち欠けにもとづく全国共通の簡易な判定であり、実際の潮位や満干の時刻は場所によって大きく異なります。正確な値は、気象庁や海上保安庁 海洋情報部の潮汐表でご確認ください。
